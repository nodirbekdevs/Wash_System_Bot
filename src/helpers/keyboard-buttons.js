module.exports = {
  ...
  owner: {
    ...
    managers: {
      uz: {
        all: "Barcha menejerlar",
        add: "Menejer qo'shish"
      },
      ru: {
        all: "Все менеджеры",
    ...
    feedback: {
      ...
      ru: {
        read: "Непрочитанные комментарии",
        doing: "Завершение комментариев",
        number: "Количество комментариев"
      }
    },
